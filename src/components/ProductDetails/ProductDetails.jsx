        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4">
          {relatedProduct?.map((item) => (
            <div className="group overflow-hidden relative cursor-pointer shadow-xl p-3 rounded-xl" key={item._id}>
              ...
              <button
                type="button"
                className="group-hover:translate-y-0 translate-y-[200%] transition-all duration-500 text-white bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br font-medium rounded-lg text-sm px-5 py-2.5 text-center mt-2 w-full"
              >
                Add To Cart
              </button>
            </div>
